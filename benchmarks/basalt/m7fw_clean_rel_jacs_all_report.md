...
|---|---:|---:|---:|
| direct clean relative-J chain (same-timestamp stereo uses captured clean J) | 8625/14016 | 129 | 1168 |
| Rust same-timestamp-zero policy (cross-time uses captured clean J) | 10089/14016 | 251 | 1168 |
...
| `same_timestamp_stereo` | 61 | 0/1464 | 1464/1464 |
...
- Rust detail: [`target/m7fv_fresh5_detail.jsonl`](../../target/m7fv_fresh5_detail.jsonl)
